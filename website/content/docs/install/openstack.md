...
- The Corium qcow2, downloaded and checked. [Downloads](/docs/install/downloads/) has
...
[Proxmox step 3](/docs/install/proxmox/#3-describe-the-node), carrying the key you
registered in step 2. It is the same block; OpenStack changes nothing about
it. [`examples/single-node.yaml`](https://github.com/Corium-OS/Corium/blob/main/docs/examples/single-node.yaml) is a complete
