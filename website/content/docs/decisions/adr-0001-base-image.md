---
title: "ADR 1 — Base image"
description: "Why the operating system is based on fedora-bootc rather than Fedora CoreOS, and what that trades away."
slug: "adr-0001-base-image"
draft: false
weight: 910
toc: true
---

<!-- Generated by website/sync-docs.py from docs/adr/0001-base-image.md. Edit that file, not this one. -->
