---
title: "ADR 7 — ZFS on data disks"
description: "Why ZFS covers data disks in a variant image rather than the base, why the kernel module is baked at build time rather than built with DKMS, and why root on ZFS is out of scope."
slug: "adr-0007-zfs-data-disks"
draft: false
weight: 970
toc: true
---

<!-- Generated by website/sync-docs.py from docs/adr/0007-zfs-data-disks.md. Edit that file, not this one. -->
...
[ADR-0003](/docs/decisions/adr-0003-software-raid-scope/)).
