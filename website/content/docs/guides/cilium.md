---
title: "Cilium"
description: "Replacing kube-router with Cilium from the node's own cloud-config: what k0s stops doing, what installs the chart, and the kube-proxy-free variant."
slug: "cilium"
draft: false
weight: 125
toc: true
...
<!-- Generated by website/sync-docs.py from docs/cilium.md. Edit that file, not this one. -->
...
That is a complete node. [`examples/custom-cni.yaml`](https://github.com/Corium-OS/Corium/blob/main/docs/examples/custom-cni.yaml)
...
[configuration reference](/docs/reference/configuration/#33-network), and what else `k0s.patch`
reaches is in [feature support](/docs/reference/feature-support/#passthrough).
