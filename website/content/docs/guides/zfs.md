...
- **It does not cover the root disk.** Like RAID, this is data disks only. Root
  ...
  [ADR-0007](/docs/reference/adr-0007-zfs-data-disks/).
...
- [Configuration reference §3.16](/docs/reference/configuration/#316-zfs)
- [Building the ZFS image](https://github.com/Corium-OS/Corium/blob/main/deploy/zfs/README.md)
- [ADR-0007: ZFS covers data disks](/docs/reference/adr-0007-zfs-data-disks/)
