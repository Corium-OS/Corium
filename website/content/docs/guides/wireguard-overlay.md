---
title: "WireGuard overlay"
description: "Joining hosts across sites or providers over an encrypted overlay from cloud-init: the escape-hatch recipe, why the tools have to be in the image, and the three things it cannot do."
slug: "wireguard-overlay"
draft: false
weight: 140
toc: true
---

<!-- Generated by website/sync-docs.py from docs/wireguard-overlay.md. Edit that file, not this one. -->

Corium has no native field for a host WireGuard interface. There is a
[proposal to add one](/docs/reference/adr-0006-host-wireguard-overlay/), but until it is
...
[native field is proposed](/docs/reference/adr-0006-host-wireguard-overlay/): if the overlay is
...
one package, following [building your own image](/docs/guides/derived-images/) for the
...
The [proposed native field](/docs/reference/adr-0006-host-wireguard-overlay/) would make Corium
...
[native field](/docs/reference/adr-0006-host-wireguard-overlay/) is meant for and this recipe
...
- **Wait for the field.** Making the overlay address the registered node address,
  ...
  [proposed `wireguard:` field](/docs/reference/adr-0006-host-wireguard-overlay/) exists to do,
...
[the field](/docs/reference/adr-0006-host-wireguard-overlay/) rather than this recipe.
...
Use the [native field](/docs/reference/adr-0006-host-wireguard-overlay/) there.
...
the [proposed field](/docs/reference/adr-0006-host-wireguard-overlay/) — and say so on the
