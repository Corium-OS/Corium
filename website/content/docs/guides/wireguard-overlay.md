...
[decided but not yet built](/docs/reference/adr-0006-host-wireguard-overlay/) (ADR 6) — and
...
[native field was chosen](/docs/reference/adr-0006-host-wireguard-overlay/): if the overlay is
...
The [native field](/docs/reference/adr-0006-host-wireguard-overlay/) (ADR 6) will make Corium
...
- **Wait for the field.** Making the overlay address the registered node address,
  ...
  [`wireguard:` field](/docs/reference/adr-0006-host-wireguard-overlay/) exists to do, and it
...
the [native field](/docs/reference/adr-0006-host-wireguard-overlay/) — once it ships; say so on
