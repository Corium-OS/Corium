...
The [quick start](/docs/guides/quickstart/) shows what to type and the
[reference](/docs/reference/configuration/) lists every field. This page is the model underneath
...
is why [k0s Autopilot is not used](/docs/reference/feature-support/#out-of-scope): it upgrades
...
See [upgrades](/docs/guides/upgrades/) for the mechanics.
