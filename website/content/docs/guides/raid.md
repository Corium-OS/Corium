...
Every field is in the [configuration reference](/docs/reference/configuration/#311-raid).
...
> that was tested. See [ADR 9](/docs/decisions/adr-0009-image-builder/).
...
- [Configuration reference §3.11](/docs/reference/configuration/#311-raid)
