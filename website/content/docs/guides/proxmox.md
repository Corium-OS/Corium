---
title: "Proxmox"
description: "A single node on a Proxmox host, from the published qcow2, with the commands and the output from a real run."
slug: "proxmox"
draft: false
weight: 118
toc: true
...
<!-- Generated by website/sync-docs.py from docs/proxmox.md. Edit that file, not this one. -->
...
published, not merely a file that downloaded without error. [Downloads](https://github.com/Corium-OS/Corium/blob/main/docs/downloads.md)
explains the chain.
...
- [Downloads](https://github.com/Corium-OS/Corium/blob/main/docs/downloads.md) — the other ways to fetch an artefact, and how to
  verify one
