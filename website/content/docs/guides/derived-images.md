...
description: "Deriving a Corium image to add your own agents, certificates or drivers: where things have to live, how to sign it so nodes accept it, and the mistakes that only show up after an upgrade."
slug: "derived-images"
draft: false
weight: 135
toc: true
...
<!-- Generated by website/sync-docs.py from docs/derived-images.md. Edit that file, not this one. -->
...
Corium's filesystem contract, from [concepts](/docs/guides/concepts/), is what makes a
...
Corium builds its own; see [downloads](/docs/install/downloads/).
...
page. See [upgrades](/docs/guides/upgrades/).
