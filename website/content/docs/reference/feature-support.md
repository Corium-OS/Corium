...
| Version ladder | n/a | `0.2.0`, `0.2` and `latest` per release. No major rung below 1.0, because a 0.x minor may break. See [upgrades](/docs/guides/upgrades/#choosing-what-to-track) |
