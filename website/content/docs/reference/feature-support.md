...
| Root filesystem on ZFS | — | Out of scope: needs the module in the initramfs, which bootc has no declarative path for. See [ADR 7](/docs/reference/adr-0007-zfs-data-disks/) |
...
Off unless asked for. The decision is [ADR 4](/docs/reference/adr-0004-management-api/); the
