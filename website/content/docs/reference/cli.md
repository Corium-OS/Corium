---
title: "cctl"
description: "Every cctl command, the three things it needs to work, what each role reaches, and how to read a refusal."
slug: "cli"
draft: false
weight: 215
toc: true
...
<!-- Generated by website/sync-docs.py from docs/cli.md. Edit that file, not this one. -->
...
[downloads](/docs/install/downloads/#installing-cctl) covers both, including how to
...
fleet pattern (see [configuration §3.2](/docs/reference/configuration/#32-role)), and a prompt on
...
node. See [ADR 4](/docs/decisions/adr-0004-management-api/).
