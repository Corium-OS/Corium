...
```bash
curl -fsSLO https://raw.githubusercontent.com/Corium-OS/Corium/v0.3.4/deploy/proxmox/create-vm.sh
...
curl -fLO https://corium.b-cdn.net/corium-0.3.4-x86_64.qcow2
```
...
```bash
sha256sum /var/lib/vz/template/corium-0.3.4-x86_64.qcow2
```
