...
| Version ladder | n/a | `0.3.4`, `0.3` and `latest` per release. No major rung below 1.0, because a 0.x minor may break. See [upgrades](upgrades.md#choosing-what-to-track) |
