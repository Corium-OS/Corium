...
cosign sign --key cosign.key ghcr.io/you/corium:0.2.0-1
```
...
```bash
cctl upgrade node-a node-b --image ghcr.io/you/corium:0.2.0-1
```
...
Corium publishes. Pin the version you tested — `0.2.0`, not `latest` — and move
it deliberately.
