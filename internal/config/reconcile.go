...
// `raid`, `zfs`, `wireguard`), or is not yet reconciled here (`upgrades`,
// `backup`, `api`, `manifests`). Changing any of those is a provisioning act.
// See ADR 8; the set the node calls safe is expected to grow.
//
